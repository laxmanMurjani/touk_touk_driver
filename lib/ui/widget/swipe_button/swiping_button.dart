...
import 'package:mozlit_driver/ui/widget/swipe_button/swipeable_widget.dart';
        ...
        children: <Widget>[
          ...
          SwipeableWidget(
            ...
            child: Container(
              ...
              shape: ((opacityVal - 0.9).isNegative ? 0.0 : (opacityVal - 0.9)) <=0?BoxShape.rectangle: BoxShape.circle,
                borderRadius:((opacityVal - 0.4).isNegative ? 0.0 : (opacityVal - 0.4)) <=0? BorderRadius.circular(height / 2):null,
              ),
            ),
            onSwipeCallback: onSwipeCallback,
